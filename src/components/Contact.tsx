            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-card border border-border/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 transition-colors ${
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-3 bg-card border border-border/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 transition-colors min-h-[150px] ${
